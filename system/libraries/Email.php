...
class CI_Email {
	...
	var	$smtp_host		= "smtp.googleemail.com";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "accounts@goldencabinetherbs.com";		// SMTP Username
	var	$smtp_pass		= "Datmyherbs14";		// SMTP Password
