<!-- Modal -->
<div class="modal fade bd-example-modal-lg" id="addPatientModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-body">
            ...
            <form action="/dashboard/patients/store" method="post" enctype="multipart/form-data" class="form-inline"> 
                <div class="form-group w-100">
                    ...
                    <div id="patientshippinginfo" class="w-100" style="display: none;">
